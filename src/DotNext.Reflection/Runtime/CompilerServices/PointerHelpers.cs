...
namespace DotNext.Runtime.CompilerServices
{
    ...
    {
        internal unsafe static object Wrap<T>(T* ptr) where T : unmanaged => Pointer.Box(ptr, typeof(T*));

        internal unsafe static T* Unwrap<T>(object ptr) where T : unmanaged => (T*)Pointer.Unbox(ptr);
