...
public static partial class Atomic
{
    ...
    public static double AccumulateAndGet<TAccumulator>(ref double value, double x, TAccumulator accumulator)
        where TAccumulator : ISupplier<double, double, double>
    ...
    public static double UpdateAndGet<TUpdater>(ref double value, TUpdater updater)
        where TUpdater : ISupplier<double, double>
    ...
    [CLSCompliant(false)]
    public static double Read(ref readonly double location) => InterlockedOperations.VolatileRead(in location);
    ...
    [CLSCompliant(false)]
    public static void Write(ref double location, double value) => InterlockedOperations.VolatileWrite(ref location, value);
}