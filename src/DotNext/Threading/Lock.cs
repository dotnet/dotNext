...
namespace DotNext.Threading
{
    ...
    public struct Lock : IDisposable, IEquatable<Lock>
    {
        ...
        public static Lock Monitor(object obj, bool useSpinWait = false) => new Lock(obj ?? throw new ArgumentNullException(nameof(obj)), useSpinWait ? Type.MonitorWithSpinWait : Type.Monitor, false);
