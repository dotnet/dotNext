...
namespace DotNext.Collections.Generic
{
    ...
    public static class Dictionary
    {
        ...
        /// </returns>
        public static V GetOrAdd<K, V>(this Dictionary<K, V> dictionary, K key, ValueFunc<K, V> valueFactory)
        {
            if (dictionary.TryGetValue(key, out var value))
                return value;
            else
        ...
        public static V GetOrAdd<K, V>(this Dictionary<K, V> dictionary, K key, Func<K, V> valueFactory)
            => GetOrAdd(dictionary, key, new ValueFunc<K, V>(valueFactory));
		...
		public static void ForEach<K, V>(this IDictionary<K, V> dictionary, ValueAction<K, V> action)
        {
		...
		public static void ForEach<K, V>(this IDictionary<K, V> dictionary, Action<K, V> action)
            => ForEach(dictionary, new ValueAction<K, V>(action));
		...
		public static V GetOrInvoke<K, V>(this IDictionary<K, V> dictionary, K key, ValueFunc<V> defaultValue)
		...
		public static V GetOrInvoke<K, V>(this IDictionary<K, V> dictionary, K key, Func<V> defaultValue)
            => GetOrInvoke(dictionary, key, new ValueFunc<V>(defaultValue));
        ...
        public static ReadOnlyDictionaryView<K, V, T> ConvertValues<K, V, T>(this IReadOnlyDictionary<K, V> dictionary, ValueFunc<V, T> mapper)
        ...
        public static ReadOnlyDictionaryView<K, V, T> ConvertValues<K, V, T>(this IReadOnlyDictionary<K, V> dictionary, Converter<V, T> mapper)
            => ConvertValues(dictionary, new ValueFunc<V, T>(mapper));
    }
}
