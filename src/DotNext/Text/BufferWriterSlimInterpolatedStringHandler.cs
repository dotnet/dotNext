...
public ref struct BufferWriterSlimInterpolatedStringHandler : IInterpolatedStringHandler
{
    ...
    public BufferWriterSlimInterpolatedStringHandler(int literalLength, int formattedCount, ref BufferWriterSlim<char> buffer, IFormatProvider? provider = null)
    {
        ...
        buffer.InternalGetSpan(IInterpolatedStringHandler.EstimateUtf16BufferSize(literalLength, formattedCount));
    }
    ...
    public void AppendFormatted<T>(T value, string? format = null)
        => count += IInterpolatedStringHandler.AppendFormatted(buffer, value, format, provider);
    ...
    public void AppendFormatted(scoped ReadOnlySpan<char> value, int alignment)
        => count += IInterpolatedStringHandler.AppendFormatted(buffer, value, alignment);
    ...
    public void AppendFormatted<T>(T value, int alignment, string? format = null)
        => count += IInterpolatedStringHandler.AppendFormatted(buffer, value, alignment, format, provider);
