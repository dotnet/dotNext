...
public struct PoolingInterpolatedStringHandler : IInterpolatedStringHandler
{
    private readonly IFormatProvider? provider;
    private InlineBufferWriter<char> writer;
    ...
    public void AppendFormatted<T>(T value, string? format = null)
        => IInterpolatedStringHandler.AppendFormatted<T, InlineBufferWriter<char>.Ref>(new(ref writer), value, format, provider);
    ...
    public void AppendFormatted(ReadOnlySpan<char> value, int alignment)
        => IInterpolatedStringHandler.AppendFormatted<InlineBufferWriter<char>.Ref>(new(ref writer), value, alignment);
    ...
    public void AppendFormatted<T>(T value, int alignment, string? format = null)
        => IInterpolatedStringHandler.AppendFormatted<T, InlineBufferWriter<char>.Ref>(new(ref writer), value, alignment, format, provider);
