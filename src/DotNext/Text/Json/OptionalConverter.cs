...
public sealed class OptionalConverter<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicFields)]T> : JsonConverter<Optional<T>>
{
    /// <inheritdoc />
