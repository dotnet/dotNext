...
public ref struct BufferWriterEncodingInterpolatedStringHandler : IInterpolatedStringHandler
{
    ...
    /// <exception cref="ArgumentNullException"><paramref name="writer"/> or <paramref name="encoder"/> is <see langword="null"/>.</exception>
    public BufferWriterEncodingInterpolatedStringHandler(int literalLength,
        int formattedCount,
        ...
        IFormatProvider? provider = null)
    {
        ...
        writer.GetSpan(IInterpolatedStringHandler.EstimateUtf8BufferSize(literalLength, formattedCount));
    }
