...
{
    [SkipLocalsInit]
    private static unsafe void Write<T>(scoped ref BufferWriterSlim<byte> builder, delegate*<Span<byte>, T, void> encoder, T value)
        where T : unmanaged
    {
    ...
    public static unsafe void WriteInt16(scoped this ref BufferWriterSlim<byte> builder, short value, bool isLittleEndian)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CLSCompliant(false)]
    public static unsafe void WriteUInt16(scoped this ref BufferWriterSlim<byte> builder, ushort value, bool isLittleEndian)
    ...
    /// <param name="isLittleEndian"><see langword="true"/> to use little-endian encoding; <see langword="false"/> to use big-endian encoding.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe void WriteInt32(scoped this ref BufferWriterSlim<byte> builder, int value, bool isLittleEndian)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CLSCompliant(false)]
    public static unsafe void WriteUInt32(scoped this ref BufferWriterSlim<byte> builder, uint value, bool isLittleEndian)
    ...
    /// <param name="isLittleEndian"><see langword="true"/> to use little-endian encoding; <see langword="false"/> to use big-endian encoding.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe void WriteInt64(scoped this ref BufferWriterSlim<byte> builder, long value, bool isLittleEndian)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [CLSCompliant(false)]
    public static unsafe void WriteUInt64(scoped this ref BufferWriterSlim<byte> builder, ulong value, bool isLittleEndian)
    ...
    /// <param name="value">The value to be encoded.</param>
    /// <param name="isLittleEndian"><see langword="true"/> to use little-endian encoding; <see langword="false"/> to use big-endian encoding.</param>
    public static unsafe void WriteSingle(scoped this ref BufferWriterSlim<byte> builder, float value, bool isLittleEndian)
    ...
    /// <param name="value">The value to be encoded.</param>
    /// <param name="isLittleEndian"><see langword="true"/> to use little-endian encoding; <see langword="false"/> to use big-endian encoding.</param>
    public static unsafe void WriteDouble(scoped this ref BufferWriterSlim<byte> builder, double value, bool isLittleEndian)
    ...
    /// <param name="value">The value to be encoded.</param>
    /// <param name="isLittleEndian"><see langword="true"/> to use little-endian encoding; <see langword="false"/> to use big-endian encoding.</param>
    public static unsafe void WriteHalf(scoped this ref BufferWriterSlim<byte> builder, Half value, bool isLittleEndian)
    ...
    public static void Write(scoped this ref BufferWriterSlim<char> writer, StringBuilder input)
    {
    ...
    public static int WriteString(scoped this ref BufferWriterSlim<char> writer, IFormatProvider? provider, [InterpolatedStringHandlerArgument(nameof(writer), nameof(provider))] scoped ref BufferWriterSlimInterpolatedStringHandler handler)
    ...
    /// <param name="handler">The handler of the interpolated string.</param>
    /// <returns>The number of written characters.</returns>
    public static int WriteString(scoped this ref BufferWriterSlim<char> writer, [InterpolatedStringHandlerArgument(nameof(writer))] scoped ref BufferWriterSlimInterpolatedStringHandler handler)
    ...
    /// <returns>The number of written characters.</returns>
    public static int WriteAsString<T>(scoped this ref BufferWriterSlim<char> writer, T value, string? format = null, IFormatProvider? provider = null)
    ...
    /// <param name="provider">The format provider.</param>
    /// <returns>The number of written characters.</returns>
    public static int WriteFormattable<T>(scoped this ref BufferWriterSlim<char> writer, T value, scoped ReadOnlySpan<char> format = default, IFormatProvider? provider = null)
    ...
    /// </summary>
    /// <param name="writer">The buffer writer.</param>
    public static void WriteLine(scoped this ref BufferWriterSlim<char> writer)
    ...
    public static void WriteLine(scoped this ref BufferWriterSlim<char> writer, scoped ReadOnlySpan<char> characters)
    {
    ...
    public static void Concat(scoped this ref BufferWriterSlim<char> writer, scoped ReadOnlySpan<string?> values)
    {
    ...
    public static void WriteFormattable<T>(scoped this ref BufferWriterSlim<byte> writer, T value)
    ...
    [RequiresPreviewFeatures]
    public static void WriteFormattable<T>(scoped this ref BufferWriterSlim<byte> writer, scoped ReadOnlySpan<T> values)
        where T : notnull, IBinaryFormattable<T>
    {
        if (values.IsEmpty)
            return;
