...
namespace DotNext
{
    ...
    [CLSCompliant(false)]
    public readonly unsafe struct Supplier<TResult> : ISupplier<TResult>, IEquatable<Supplier<TResult>>
    {
        ...
        public bool Equals(Supplier<TResult> other) => ptr == other.ptr;
        ...
        /// <param name="other">The object to be compared.</param>
        /// <returns><see langword="true"/> if this object contains the same pointer as the specified object.</returns>
        public override bool Equals(object? other) => other is Supplier<TResult> supplier && Equals(supplier);
        ...
        public static bool operator ==(Supplier<TResult> x, Supplier<TResult> y)
            => x.Equals(y);
