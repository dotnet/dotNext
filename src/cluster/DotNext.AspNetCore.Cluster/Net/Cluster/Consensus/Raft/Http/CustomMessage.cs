...
namespace DotNext.Net.Cluster.Consensus.Raft.Http
{
    ...
    internal class CustomMessage : HttpMessage, IHttpMessageWriter<IMessage>, IHttpMessageReader<IMessage?>
    {
        ...
        private protected CustomMessage(ClusterMemberId sender, IMessage message, DeliveryMode mode)
        ...
        internal CustomMessage(ClusterMemberId sender, IMessage message, bool requiresConfirmation)
