...
namespace DotNext.Net.Cluster.Consensus.Raft.Http.Hosting
{
    ...
    /// </summary>
    [CLSCompliant(false)]
    public interface IClusterMemberHostBuilder
    {
        /// <summary>
    ...
    {
        private readonly IClusterMemberHostBuilder? builder;

        internal ClusterMemberHostBuilder(IClusterMemberHostBuilder? builder)
