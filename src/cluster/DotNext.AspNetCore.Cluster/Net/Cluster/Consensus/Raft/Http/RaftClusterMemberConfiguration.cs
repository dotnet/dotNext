...
namespace DotNext.Net.Cluster.Consensus.Raft.Http
{
    ...
    internal class RaftClusterMemberConfiguration : ClusterMemberConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets the request timeout, in milliseconds, used for election-related messages sent to other nodes in the cluster.
        /// If not specified, defaults to the value of <see cref="ClusterMemberConfiguration.UpperElectionTimeout"/>.
        /// </summary>
        public int? ElectionRequestTimeout { get; set; }
