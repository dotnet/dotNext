...
namespace DotNext.Net.Cluster.Consensus.Raft
{
    ...
    public partial class RaftCluster<TMember>
    {
        ...
        protected static DistributedLockProvider? TryCreateLockProvider<TCluster>(TCluster cluster, TMember localMember)
            ...
            => !localMember.IsRemote && cluster.auditTrail is IDistributedLockEngine engine ? new DistributedLockProvider(engine, cluster.LeaderRouter, localMember.Id, cluster.auditTrail, cluster.Logger) : null;
    }
}