...
namespace DotNext.Net.Cluster.Consensus.Raft
{
    ...
    public sealed class PersistentState : Disposable, IPersistentState
    {
        ...
        private sealed class LogEntry : IRaftLogEntry
        {
        ...
        private sealed class Partition : Disposable
        {
            ...
            private const long PayloadOffset = RecordIndexOffsetOffset + sizeof(long);
            ...
            internal IRaftLogEntry this[long index]
            {
                get
                {
                    ...
                    if (index == 0L && offset == 0L)
                        return InMemoryAuditTrail.First;
                    index -= offset;
        ...
        ref readonly IRaftLogEntry IAuditTrail.First => ref InMemoryAuditTrail.First;
