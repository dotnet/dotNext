...
namespace DotNext.Net.Cluster.Consensus.Raft
{
    ...
    public interface IRaftClusterMember : IClusterMember
    {
        ...
        Task<Result<bool>> VoteAsync(long term, LogEntryId? lastEntry, CancellationToken token);
        ...
        Task<Result<bool>> AppendEntriesAsync(long term, IReadOnlyList<ILogEntry<LogEntryId>> entries, LogEntryId precedingEntry, long commitIndex, CancellationToken token);
