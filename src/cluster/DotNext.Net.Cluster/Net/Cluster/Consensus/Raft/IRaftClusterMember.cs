...
namespace DotNext.Net.Cluster.Consensus.Raft
{
    ...
    public interface IRaftClusterMember : IClusterMember
    {
        ...
        Task HeartbeatAsync(long term, CancellationToken token);
        ...
        Task<bool> AppendEntriesAsync(long term, ILogEntry<LogEntryId> newEntry, LogEntryId precedingEntry, CancellationToken token);
