...
namespace DotNext.IO
{
    ...
    internal sealed class EmptyBinaryReader : IAsyncBinaryReader
    {
        ...
        ValueTask<int> IAsyncBinaryReader.ReadInt32Async(StringLengthEncoding lengthFormat, DecodingContext context, NumberStyles style = NumberStyles.Integer, IFormatProvider? provider, CancellationToken token)
            => EndOfStream<int>();
        ...
        ValueTask<Guid> IAsyncBinaryReader.ReadGuidAsync(StringLengthEncoding lengthFormat, DecodingContext context, string format, CancellationToken token = default)
            => EndOfStream<Guid>();
