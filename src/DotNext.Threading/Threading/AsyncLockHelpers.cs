...
namespace DotNext.Threading
{
    internal static class AsyncLockHelpers
    {
        ...
        internal static Task CheckOnTimeout(this Task<bool> continuation) => continuation.ContinueWith(CheckOnTimeoutAction, TaskContinuationOptions.ExecuteSynchronously | TaskContinuationOptions.OnlyOnRanToCompletion);
    }
}