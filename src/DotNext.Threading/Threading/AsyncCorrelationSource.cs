...
namespace DotNext.Threading
{
    ...
    /// before the call to <see cref="TryPulse(TKey, TValue)"/> by the producer for the same key.
    /// </remarks>
        ...
        where TKey : notnull
    {
        ...
        public bool TryPulse(TKey eventId, TValue value)
        ...
        /// </summary>
        /// <param name="eventId">The unique identifier of the event.</param>
        /// <param name="timeout">The time to wait for <see cref="TryPulse(TKey, TValue)"/>.</param>
