...
var itemType = typeof(List<string>).ItemType;  //itemType == typeof(string)
```
...
var dispose = typeof(Stream).DisposeMethod;
```
...
var t = typeof(Task<int>).TaskGenericArgument;  //t == typeof(int)
t = typeof(Task).TaskGenericArgument;           //t == typeof(void)
```
